...
public class Producer_PowerData_Minute {
    public static void main(String[] args) throws JSONException, IOException {
        ...
        for (int p = 0; p < k.length(); p++) {
            ...
            producer.send(new ProducerRecord<String, String>("PowerData_Minute", i.getString("location"), formattedDate + ","
            ...
            System.out.println(new ProducerRecord<String, String>("powerdata_minute", i.getString("location"), formattedDate + ","
                    + i.getString("location") + ","
                    + i.getString("KW") + ","
                    + i.getString("totalKWH") + ","
                    + i.getString("ch1_pf") + ","
